...
public class ClienteController {
    ...
    @PutMapping(path = "/{id}")
    public ResponseEntity update(@PathVariable("id") Long id, @Valid @RequestBody Cliente cliente) throws NotFoundException {
        cliente.setId(id);
    ...
    public ResponseEntity uploadFile(@PathVariable("id") Long id, MultipartFile file) throws NotFoundException {
